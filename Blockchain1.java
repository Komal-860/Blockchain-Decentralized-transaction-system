...
public class Blockchain1 {
	...
	public static int difficulty = 5;
        ...
        public static int Blockchaindata(String data)
        {
            ...
            String PrevHash=GetPreviousHash1();
            Dbconn.PrevHash1=PrevHash;
            
            blockchain1=GetChain1();
			// if genasis
            ...
            System.out.println("System Mine the Current First BlockChain Transaction ");
	...
	public static ArrayList<Block> GetChain1() throws Exception
        {
            String previous="0";
            ArrayList<Block> wholeTransactionChain = new ArrayList<Block>();
            Connection con  = (Connection) Dbconn.conn1();
      ...
      public static ArrayList<String> GetChainConsensus1() throws Exception
        {
...
public static String GetPreviousHash1()
{
            String finalhash="0";    
           try
           {
...
// This is the strategy of consensus algorithm, and its applicable for n nodes
        public static Boolean isChainValid1() throws Exception {
		 ArrayList<String> CompleteList =new ArrayList<String>();
                 int flag=0;
                 String hashTarget = new String(new char[difficulty]).replace('\0', '0');
                 CompleteList =GetChainConsensus1();
